...
import type { ContactPersonsListResponse, ContactPerson, ContactPersonRaw } from '../types/brand';
...
export type { ContactPerson, ContactPersonsListResponse, ContactPersonRaw } from '../types/brand';
