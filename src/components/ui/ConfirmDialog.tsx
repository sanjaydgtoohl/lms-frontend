              ...
              <div className="flex-1 w-full">
                ...
                <div className="mt-8 flex items-center justify-center gap-3 w-full">
                  <button
                    disabled={loading}
                    onClick={onCancel}
                    className="flex-1 inline-flex items-center justify-center px-5 py-3 rounded-lg border border-gray-200 text-sm font-semibold text-gray-700 !bg-gray-200 hover:!bg-gray-300 transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed shadow-sm"
                  >
                    {cancelLabel}
                  </button>
