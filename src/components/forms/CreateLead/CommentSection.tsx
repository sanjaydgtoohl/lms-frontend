    ...
    <div className="w-full bg-white rounded-2xl shadow-sm border border-gray-200">
      <div className="px-4 py-5 p-5 bg-[#F9FAFB]">
        ...
        <textarea
          ...
          className="w-full h-28 px-3 py-2 border border-gray-200 rounded-lg bg-white text-[var(--text-primary)] focus:outline-none focus:ring-2 focus:ring-blue-500 resize-none transition-colors"
        />
      </div>
    </div>
  );
