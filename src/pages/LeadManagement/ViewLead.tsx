      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="bg-white rounded-lg border border-gray-200 shadow-sm p-5">
            <h2 className="text-lg font-semibold text-gray-800 mb-6">Lead Overview</h2>
            <div className="grid grid-cols-2 md:grid-cols-3 gap-6">
              ...
              {/* Lead Status */}
              <div className='flex gap-3 items-center justify-start'>
                <label className="text-sm font-semibold text-gray-800">Lead Status : </label>
          ...
          <div className="bg-white rounded-lg border border-gray-200 shadow-sm p-5">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <p className="text-base font-medium text-gray-800">{lead.designation?.name || 'Not Set'}</p>
              </div>
              {/* Department */}
              <div>
                <label className="text-sm font-medium text-gray-600 block mb-2">Department</label>
                <p className="text-base font-medium text-gray-800">{lead.department?.name || 'Not Set'}</p>
              </div>
              {/* Email */}
              <div>
                <div className="flex items-center text-sm font-medium text-gray-600 mb-2">
          ...
          <div className="bg-white rounded-lg border border-gray-200 shadow-sm p-5">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
              <div>
                ...
                <p className="text-base font-medium text-gray-800">{lead.country?.name || 'Not Set'}</p>
              </div>
              <div>
                <label className="text-sm font-medium text-gray-600 block mb-1">State</label>
                <p className="text-base font-medium text-gray-800">{lead.state?.name || 'Not Set'}</p>
              </div>
              <div>
                <label className="text-sm font-medium text-gray-600 block mb-1">City</label>
                <p className="text-base font-medium text-gray-800">{lead.city?.name || 'Not Set'}</p>
              </div>
              <div>
                <label className="text-sm font-medium text-gray-600 block mb-1">Zone</label>
                <p className="text-base font-medium text-gray-800">{lead.zone?.name || 'Not Set'}</p>
              </div>
              <div>
                <label className="text-sm font-medium text-gray-600 block mb-1">Postal Code</label>
                <p className="text-base font-medium text-gray-800">{lead.postal_code || 'Not Set'}</p>
              </div>
            </div>
          </div>
